...
text(-12,20,paste('Right Handers: r = ',mycor_RH))
text(-12                 
     ,13,paste('Left Handers: r = ',mycor_LH), col='red')
pData<-cbind(alltask,particdat)
covEllipses(x=pData[,c('f1score','f2score')],group=pData$handcode,pooled=FALSE,add=TRUE,col=c("black","red"),labels="")
