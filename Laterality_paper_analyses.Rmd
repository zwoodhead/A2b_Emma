...
# Fix omitted responses data
omit.cols<- grep('*.Omit',colnames(behavdat))

# The number of events in each condition
nevents <- c(15, 15, 15, 15, # task A1, D1, A2, D2
             90, 90, 90, 45, # tasks B1, C1, E1, F1
             90, 90, 90, 45) # tasks B2, C2, E2, F2
