...
t.test(taskA_LG~particdat$handcode)
plot(taskA_LG~particdat$handcode)

taskB_PD<-(alltaskall$PhonDec1+alltaskall$PhonDec2)/2
t.test(taskB_PD~particdat$handcode)
plot(taskB_PD~particdat$handcode)

taskC_SD<-(alltaskall$SemDec1+alltaskall$SemDec2)/2
t.test(taskC_SD~particdat$handcode)
plot(taskC_SD~particdat$handcode)

taskD_SG<-(alltaskall$SentGen1+alltaskall$SentGen2)/2
t.test(taskD_SG~particdat$handcode)
plot(taskD_SG~particdat$handcode)

taskE_SC<-(alltaskall$SentComp1+alltaskall$SentComp2)/2
t.test(taskE_SC~particdat$handcode)
plot(taskE_SC~particdat$handcode)

taskF_JD<-(alltaskall$Jabber1+alltaskall$Jabber2)/2
t.test(taskF_JD~particdat$handcode)
plot(taskF_JD~particdat$handcode)
