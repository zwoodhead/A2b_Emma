...
data1 <- read.csv('https://osf.io/ntjea/download')
data2 <- read.csv('https://osf.io/nstq9/download')
...
behavdat_Bangor <- read.csv('https://osf.io/mzgan/download') # Downloads A2_Behavioural_Data_Bangor.csv from OSF
...
if(!file.exists('geom_pirate_ZW.R')){download('https://osf.io/hyjxq/download', dest = 'geom_pirate_ZW.R')}
