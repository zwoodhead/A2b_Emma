...
```{r behaviouraldata}
osf_retrieve_file('https://osf.io/wznbv') %>% osf_download(conflicts = 'overwrite') # A2_Behavioural_Data.csv
behavdat_A2    <- read.csv('A2_Behavioural_Data.csv')
osf_retrieve_file('https://osf.io/mzgan') %>% osf_download(conflicts = 'overwrite') # A2_Behavioural_Data_Bangor.csv
